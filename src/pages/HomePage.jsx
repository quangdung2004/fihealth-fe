...
export function HomePage() {
    ...
    return (
        <Box sx={{ minHeight: "100vh", bgcolor: "#fff", fontFamily: "'Poppins', sans-serif" }}>
            {/* Header/Navigation */}
            <Box
                sx={{
            ...
            <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
                ...
                >
                    ...
                    <Box>
                        ...
                        <Typography sx={{ mt: 2, color: "text.secondary", fontFamily: "'Poppins', sans-serif" }}>
                            Đã có tài khoản?{" "}
                            <Box
                                component="span"
                                sx={{
            ...
            <Container maxWidth="lg" sx={{ py: 8 }} id="features">
                <Box sx={{ textAlign: "center", mb: 6 }}>
                    ...
                    <Typography variant="h6" color="text.secondary" fontWeight={400} sx={{ fontFamily: "'Poppins', sans-serif" }}>
                ...
                <Stack spacing={4}>
                    ...
                    >
                        ...
                        <Box sx={{ flex: 1 }}>
                            ...
                            />
                            <Typography variant="h3" sx={{ fontSize: "1.8rem", fontWeight: 800, mb: 2, fontFamily: "'Poppins', sans-serif" }}>
                                Lưu Trữ Hồ Sơ Y Tế Thông Minh
                            </Typography>
                            <Typography sx={{ color: "text.secondary", mb: 2, lineHeight: 1.7, fontFamily: "'Poppins', sans-serif" }}>
                ...
                <Container maxWidth="lg">
                    ...
                    >
                        <Box sx={{ flex: 1 }}>
                            ...
                            <Typography sx={{ color: "text.secondary", mb: 4, lineHeight: 1.7, fontFamily: "'Poppins', sans-serif" }}>
                            ...
                            <Stack spacing={2}>
                                {[
                                    ...
                                    <Box key={idx} sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
                                        ...
                                        <Typography sx={{ fontSize: "1.05rem", fontWeight: 500, fontFamily: "'Poppins', sans-serif" }}>
                                            {benefit}
                                        </Typography>
                                    </Box>
                                ))}
            ...
            >
                <Container maxWidth="lg">
                    <Typography sx={{ mb: 1, fontFamily: "'Poppins', sans-serif" }}>
                        © 2026 FiHealth. All rights reserved.
                    </Typography>
                    <Typography variant="body2" sx={{ opacity: 0.7, fontFamily: "'Poppins', sans-serif" }}>
